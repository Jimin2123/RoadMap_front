...
const placeholderJobs: Job[] = [
  ...
  },
  {
    ...
    companyName: '카카오뱅크',
    reason:
      '안정적인 서비스 운영 경험과 MSA에 대한 이해도를 필요로 하는 포지션으로, 백엔드 역량을 강화할 수 있습니다.',
  },
  {
    rank: 5,
    companyName: '당근마켓',
  ...
  },
  {
    ...
    companyName: '우아한형제들',
    reason:
      '배달 서비스의 핵심 로직을 개발하고 운영하는 포지션입니다. MSA 환경에서의 개발 경험을 쌓을 수 있습니다.',
  },
  {
    rank: 8,
    companyName: 'SK텔레콤',
...
const SkeletonCard: React.FC = () => (
  <div className={`${styles.card} ${styles.skeleton}`}>
    ...
    <div
      ...
      style={{ borderTop: 'none', paddingTop: '20px' }}
    >
      <div
        className={`${styles.skeletonItem} ${styles.skeletonText}`}
        style={{
...
const MatchingPage: React.FC = () => {
  ...
  const filteredJobs = showBookmarkedOnly
    ? jobs.filter(job => bookmarks.includes(job.rank))
    : jobs;
      ...
      <main className={styles.mainContent}>
        <div className={styles.introSection}>
          ...
          <p className={styles.subtitle}>
            회원님의 프로필과 역량을 기반으로 가장 적합한 채용 공고를 추천해
            드립니다.
          </p>
        </div>
          ...
          {loading ? (
            ...
            paginatedJobs.map((job) => (
              <div
                ...
                onClick={() => handleCardClick(job.companyName)}
              >
                <div className={styles.cardHeader}>
