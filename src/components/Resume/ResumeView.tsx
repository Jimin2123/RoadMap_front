...
import { FaUser, FaFileAlt, FaBriefcase, FaProjectDiagram, FaUsers, FaGraduationCap, FaCertificate, FaBook } from 'react-icons/fa';
          ...
          projects.length > 0 && (
            <ul className="content-section">
              {projects.map((proj: ProjectResponse, index: number) => (
                <li key={index}>
                  <strong>{proj.name}</strong> ({proj.period})
      ...
      <div className="resume-container">
        <div className="resume-header">
          <div className="resume-header-left">
            <div className="avatar-box"> <FaUser className="avatar-placeholder" />
